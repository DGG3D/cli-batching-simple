...
for inputFile in inputFiles:
    ...
    #            break            
        ...
        #### qa mode is true ####
        #if qa_mode:
        #    outputDirName = outFileprefixAuxOutput + outputSuffix + ".glb"
        #    cmdline.append("-e")
        #    cmdline.append("\"" + outputDirName + "\"")

        else:
            # export to file(s)
            #for outFileFormat in outputFormats:  
                #outputDirName = outFileprefixAux + "/" + fnameStem       
                cmdline.append("-o")
                cmdline.append(outFileprefixAux)
